The raw data is collected by a Google Form and stored in a Google Sheet. There is an item on the roadmap to develop a custom survey app using Flask to acquire this data.
